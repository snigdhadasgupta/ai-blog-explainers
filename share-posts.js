window.__POSTS__ = [
  ...
  },
  {
    ...
    "category": "Product",
    "date": "2026-08-26",
    "hook": "It checks every action",
    "body": "Claude in Chrome reaches every paid plan and can act on its own -- but a safety classifier vets each action against your request. On the current red-team eval, zero attacks landed against Sonnet 5 or Opus 5."
  },
  {
    ...
    "category": "Product",
    "date": "2026-08-26",
    "hook": "Claude's own browser",
    "body": "Cowork gets a browser built in -- it opens sites, reads pages, and fills forms while you keep working. No extension, and your tabs, bookmarks, and passwords never come along."
  },
  {
    "slug": "when-ai-infrastructure-becomes-target-securing-gateways-control-points",
    "source": "Microsoft Security",
    "category": "AI Governance",
    "date": "2026-08-26",
    "hook": "Your AI gateway is Tier-0",
    "body": "Microsoft found attackers treating AI gateways, RAG platforms, and orchestrators as a control plane -- stealing keys, persisting, and mining crypto. Treat a LiteLLM proxy like a secrets store, never exposed to the internet."
  },
  {
    "slug": "agentic-ai-and-intelligent-content-management-financial-services-use-cases-capabilities-and",
    "source": "Box",
    "category": "Enterprise AI",
    "date": "2026-08-26",
    "hook": "Agents need governed content",
    "body": "Financial firms are moving from chatbots to agents that plan and execute -- but 90% of their data is unstructured. Box's answer: metadata extraction and permissions-aware RAG before any agent goes live."
  },
  {
    "slug": "trademark-property-uses-box-apis-turn-thousands-lease-documents-actionable-data-minutes",
    "source": "Box",
    "category": "Case Study",
    "date": "2026-08-26",
    "hook": "48 hours to minutes",
    "body": "Trademark Property replaced a $150-200-per-document, two-day lease abstraction process with Box AI -- now minutes at near-zero cost, with cross-portfolio clause search and projected savings of $450-800K."
  },
  {
  ...
  },
  {
    ...
    "category": "Product",
    "date": "2026-08-25",
    "hook": "One memory, everywhere",
    "body": "The memory Claude uses in chat is now the same one in Cowork -- editable topic by topic, updated as you chat, and off by default for health, beliefs, and other sensitive subjects."
  },
  {
    "slug": "i-built-claude-skill-helps-agent-not-get-lost-knowledge-base",
    "source": "Box",
    "category": "Agents",
    "date": "2026-08-25",
    "hook": "Give the agent a map",
    "body": "A Box developer's Claude Skill reads a routing map in Box instead of letting an agent wander a folder tree -- it links to the right sources and saves new drafts back into the workspace, never into chat."
  },
  {
  ...
  },
  {
    ...
    "category": "AI Governance",
    "date": "2026-07-16",
    "hook": "Least privilege for agents.",
    "body": "Agents chain actions across systems with no human approving each step. Give every agent a managed identity, task-based RBAC, tight scope, and safe tool binding."
  },
  {
    "slug": "ust-claude",
    "source": "Anthropic",
  ...
  {
    "slug": "copilot-in-excel-frontier-finance",
    "source": "Microsoft 365",
    "category": "Productivity",
    "date": "2026-06-25",
  ...
  },
  {
    ...
    "category": "Productivity",
    "date": "2026-06-25",
    "hook": "AI across Workspace.",
    "body": "Google's June drop adds AI to auto-organize Drive files, fix Sheets formula errors with Gemini, and refine Gmail drafts with an improved Help me write."
  },
  {
  ...
  {
    "slug": "microsoft-agent-365-now-generally-available-expands-capabilities-and-integrations",
    "source": "Microsoft Security",
    "category": "AI Governance",
    "date": "2026-05-01",
